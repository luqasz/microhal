#ifndef atmega128_sfr_h
#define atmega128_sfr_h
...
namespace SFR {
    ...
    struct ADCSRA {
        ...
        enum bits : uint8_t {
            ...
            ADFR  = 32,  // ADC  Free Running Select
    ...
    struct XDIV {
        ...
        enum bits : uint8_t {
            XDIV0  = 1,   // XTAL Divide Select Bit 0
            XDIV1  = 2,   // XTAL Divide Select Bit 1
            XDIV2  = 4,   // XTAL Divide Select Bit 2
            XDIV3  = 8,   // XTAL Divide Select Bit 3
            XDIV4  = 16,  // XTAL Divide Select Bit 4
            XDIV5  = 32,  // XTAL Divide Select Bit 5
            XDIV6  = 64,  // XTAL Divide Select Bit 6
