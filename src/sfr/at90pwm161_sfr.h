#ifndef at90pwm161_sfr_h
#define at90pwm161_sfr_h
...
namespace SFR {
    ...
    struct OCR0SB {
        static const uint16_t address = 0x42;
    };
    ...
    struct DACH {
        ...
        enum bits : uint8_t {
            DACH0 = 1,   // DAC Data Register High Byte Bits
            DACH1 = 2,   // DAC Data Register High Byte Bits
            DACH2 = 4,   // DAC Data Register High Byte Bits
            DACH3 = 8,   // DAC Data Register High Byte Bits
            DACH4 = 16,  // DAC Data Register High Byte Bits
            DACH5 = 32,  // DAC Data Register High Byte Bits
            DACH6 = 64,  // DAC Data Register High Byte Bits
            DACH7 = 128, // DAC Data Register High Byte Bits
        };
    };

    // Timer/Counter1  Bytes
    struct TCNT1 {
        static const uint16_t address = 0x5a;
    };
    ...
    struct PICR2H {
        ...
        enum bits : uint8_t {
            ...
            PICR210 = 4,   //
            PICR211 = 8,   //
            PCST2   = 128, // PSC 2 Capture Software Trigger Bit
        };
    };
    ...
    struct DIDR0 {
        ...
        enum bits : uint8_t {
            ...
            ADC6D = 64,  // ADC7 Digital input Disable
            ADC7D = 128, //
        };
    };
