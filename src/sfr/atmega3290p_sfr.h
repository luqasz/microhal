#ifndef atmega3290p_sfr_h
#define atmega3290p_sfr_h
...
namespace SFR {
    ...
    struct LCDCCR {
        ...
        enum bits : uint8_t {
            LCDCC0 = 1,   // LCD Contrast Control
            LCDCC1 = 2,   // LCD Contrast Control
            LCDCC2 = 4,   // LCD Contrast Control
            LCDCC3 = 8,   // LCD Contrast Control
            LCDMDT = 16,  // LCD Maximum Drive Time
            LCDDC0 = 32,  // LCD Display Configurations
            LCDDC1 = 64,  // LCD Display Configurations
            LCDDC2 = 128, // LCD Display Configurations
        };
    };
