#ifndef at90pwm3b_sfr_h
#define at90pwm3b_sfr_h
...
namespace SFR {
    ...
    struct OCR0A {
        ...
        enum bits : uint8_t {
            OCR0A0 = 1,   // Timer/Counter0 Output Compare A
            OCR0A1 = 2,   // Timer/Counter0 Output Compare A
            OCR0A2 = 4,   // Timer/Counter0 Output Compare A
            OCR0A3 = 8,   // Timer/Counter0 Output Compare A
            OCR0A4 = 16,  // Timer/Counter0 Output Compare A
            OCR0A5 = 32,  // Timer/Counter0 Output Compare A
            OCR0A6 = 64,  // Timer/Counter0 Output Compare A
            OCR0A7 = 128, // Timer/Counter0 Output Compare A
        };
    };
    ...
    struct OCR0B {
        ...
        enum bits : uint8_t {
            OCR0B0 = 1,   // Timer/Counter0 Output Compare B
            OCR0B1 = 2,   // Timer/Counter0 Output Compare B
            OCR0B2 = 4,   // Timer/Counter0 Output Compare B
            OCR0B3 = 8,   // Timer/Counter0 Output Compare B
            OCR0B4 = 16,  // Timer/Counter0 Output Compare B
            OCR0B5 = 32,  // Timer/Counter0 Output Compare B
            OCR0B6 = 64,  // Timer/Counter0 Output Compare B
            OCR0B7 = 128, // Timer/Counter0 Output Compare B
        };
    };
    ...
    struct ADCSRB {
        ...
        enum bits : uint8_t {
            ...
            ADTS3 = 8,   // ADC Auto Trigger Source
    ...
    struct ICR1 {
        ...
        enum bits : uint8_t {
            ICR10 = 1,   // Timer/Counter1 Input Capture
            ICR11 = 2,   // Timer/Counter1 Input Capture
            ICR12 = 4,   // Timer/Counter1 Input Capture
            ICR13 = 8,   // Timer/Counter1 Input Capture
            ICR14 = 16,  // Timer/Counter1 Input Capture
            ICR15 = 32,  // Timer/Counter1 Input Capture
            ICR16 = 64,  // Timer/Counter1 Input Capture
            ICR17 = 128, // Timer/Counter1 Input Capture
        };
    };
    ...
    struct OCR1A {
        ...
        enum bits : uint8_t {
            OCR1A0 = 1,   // Timer/Counter1 Output Compare A
            OCR1A1 = 2,   // Timer/Counter1 Output Compare A
            OCR1A2 = 4,   // Timer/Counter1 Output Compare A
            OCR1A3 = 8,   // Timer/Counter1 Output Compare A
            OCR1A4 = 16,  // Timer/Counter1 Output Compare A
            OCR1A5 = 32,  // Timer/Counter1 Output Compare A
            OCR1A6 = 64,  // Timer/Counter1 Output Compare A
            OCR1A7 = 128, // Timer/Counter1 Output Compare A
        };
    };
    ...
    struct OCR1B {
        ...
        enum bits : uint8_t {
            OCR1B0 = 1,   // Timer/Counter1 Output Compare B
            OCR1B1 = 2,   // Timer/Counter1 Output Compare B
            OCR1B2 = 4,   // Timer/Counter1 Output Compare B
            OCR1B3 = 8,   // Timer/Counter1 Output Compare B
            OCR1B4 = 16,  // Timer/Counter1 Output Compare B
            OCR1B5 = 32,  // Timer/Counter1 Output Compare B
            OCR1B6 = 64,  // Timer/Counter1 Output Compare B
            OCR1B7 = 128, // Timer/Counter1 Output Compare B
        };
    };
    ...
    struct PIFR1 {
        ...
        enum bits : uint8_t {
            PEOP1  = 1,   // End of PSC1 Interrupt
            PRN10  = 2,   // Ramp Number
            PRN11  = 4,   // Ramp Number
            PEV1A  = 8,   // External Event A Interrupt
            PEV1B  = 16,  // External Event B Interrupt
            PSEI1  = 32,  // PSC 1 Synchro Error Interrupt
            POAC1A = 64,  // PSC 1 Output A Activity
            POAC1B = 128, // PSC 1 Output B Activity
        };
    };

    // PSC1 Interrupt Mask Register
    struct PIM1 {
        static const uint8_t address = 0xa3;
        enum bits : uint8_t {
            PEOPE1 = 1,  // End of Cycle Interrupt Enable
            PEVE1A = 8,  // External Event A Interrupt Enable
            PEVE1B = 16, // External Event B Interrupt Enable
            PSEIE1 = 32, // PSC 1 Synchro Error Interrupt Enable
        };
    };
    ...
    struct UDR {
        ...
        enum bits : uint8_t {
            UDR0 = 1,   // USART I/O Data
            UDR1 = 2,   // USART I/O Data
            UDR2 = 4,   // USART I/O Data
            UDR3 = 8,   // USART I/O Data
            UDR4 = 16,  // USART I/O Data
            UDR5 = 32,  // USART I/O Data
            UDR6 = 64,  // USART I/O Data
            UDR7 = 128, // USART I/O Data
        };
    };
    ...
    struct EUDR {
        ...
        enum bits : uint8_t {
            EUDR0 = 1,   // EUSART Extended data bits
            EUDR1 = 2,   // EUSART Extended data bits
            EUDR2 = 4,   // EUSART Extended data bits
            EUDR3 = 8,   // EUSART Extended data bits
            EUDR4 = 16,  // EUSART Extended data bits
            EUDR5 = 32,  // EUSART Extended data bits
            EUDR6 = 64,  // EUSART Extended data bits
            EUDR7 = 128, // EUSART Extended data bits
        };
    };
    ...
    struct OCR0SA {
        ...
        enum bits : uint8_t {
            OCR0SA0 = 1,   // Output Compare SA
            OCR0SA1 = 2,   // Output Compare SA
            OCR0SA2 = 4,   // Output Compare SA
            OCR0SA3 = 8,   // Output Compare SA
            OCR0SA4 = 16,  // Output Compare SA
            OCR0SA5 = 32,  // Output Compare SA
            OCR0SA6 = 64,  // Output Compare SA
            OCR0SA7 = 128, // Output Compare SA
        };
    };
    ...
    struct OCR0RA {
        ...
        enum bits : uint8_t {
            OCR0RA0 = 1,   // Output Compare RA
            OCR0RA1 = 2,   // Output Compare RA
            OCR0RA2 = 4,   // Output Compare RA
            OCR0RA3 = 8,   // Output Compare RA
            OCR0RA4 = 16,  // Output Compare RA
            OCR0RA5 = 32,  // Output Compare RA
            OCR0RA6 = 64,  // Output Compare RA
            OCR0RA7 = 128, // Output Compare RA
        };
    };
    ...
    struct OCR0SB {
        ...
        enum bits : uint8_t {
            OCR0SB0 = 1,   // Output Compare SB
            OCR0SB1 = 2,   // Output Compare SB
            OCR0SB2 = 4,   // Output Compare SB
            OCR0SB3 = 8,   // Output Compare SB
            OCR0SB4 = 16,  // Output Compare SB
            OCR0SB5 = 32,  // Output Compare SB
            OCR0SB6 = 64,  // Output Compare SB
            OCR0SB7 = 128, // Output Compare SB
        };
    };
    ...
    struct OCR0RB {
        ...
        enum bits : uint8_t {
            OCR0RB0 = 1,   // Output Compare RB
            OCR0RB1 = 2,   // Output Compare RB
            OCR0RB2 = 4,   // Output Compare RB
            OCR0RB3 = 8,   // Output Compare RB
            OCR0RB4 = 16,  // Output Compare RB
            OCR0RB5 = 32,  // Output Compare RB
            OCR0RB6 = 64,  // Output Compare RB
            OCR0RB7 = 128, // Output Compare RB
        };
    };
    ...
    struct PSOC1 {
        ...
        enum bits : uint8_t {
            POEN1A   = 1,  // PSCOUT10 Output Enable
            POEN1B   = 4,  // PSCOUT11 Output Enable
            PSYNC1_0 = 16, // Synchronization Out for ADC Selection
            PSYNC1_1 = 32, // Synchronization Out for ADC Selection
        };
    };
    ...
    struct OCR1SA {
        ...
        enum bits : uint8_t {
            OCR1SA0 = 1,   // Output Compare 1 SA
            OCR1SA1 = 2,   // Output Compare 1 SA
            OCR1SA2 = 4,   // Output Compare 1 SA
            OCR1SA3 = 8,   // Output Compare 1 SA
            OCR1SA4 = 16,  // Output Compare 1 SA
            OCR1SA5 = 32,  // Output Compare 1 SA
            OCR1SA6 = 64,  // Output Compare 1 SA
            OCR1SA7 = 128, // Output Compare 1 SA
        };
    };
    ...
    struct OCR1RA {
        ...
        enum bits : uint8_t {
            OCR1RA0 = 1,   // Output Compare 1 RA
            OCR1RA1 = 2,   // Output Compare 1 RA
            OCR1RA2 = 4,   // Output Compare 1 RA
            OCR1RA3 = 8,   // Output Compare 1 RA
            OCR1RA4 = 16,  // Output Compare 1 RA
            OCR1RA5 = 32,  // Output Compare 1 RA
            OCR1RA6 = 64,  // Output Compare 1 RA
            OCR1RA7 = 128, // Output Compare 1 RA
        };
    };
    ...
    struct OCR1SB {
        ...
        enum bits : uint8_t {
            OCR1SB0 = 1,   // Output Compare 1 SB
            OCR1SB1 = 2,   // Output Compare 1 SB
            OCR1SB2 = 4,   // Output Compare 1 SB
            OCR1SB3 = 8,   // Output Compare 1 SB
            OCR1SB4 = 16,  // Output Compare 1 SB
            OCR1SB5 = 32,  // Output Compare 1 SB
            OCR1SB6 = 64,  // Output Compare 1 SB
            OCR1SB7 = 128, // Output Compare 1 SB
        };
    };
    ...
    struct OCR1RB {
        ...
        enum bits : uint8_t {
            OCR1RB0 = 1,   // Output Compare 1 RB
            OCR1RB1 = 2,   // Output Compare 1 RB
            OCR1RB2 = 4,   // Output Compare 1 RB
            OCR1RB3 = 8,   // Output Compare 1 RB
            OCR1RB4 = 16,  // Output Compare 1 RB
            OCR1RB5 = 32,  // Output Compare 1 RB
            OCR1RB6 = 64,  // Output Compare 1 RB
            OCR1RB7 = 128, // Output Compare 1 RB
        };
    };
    ...
    struct PCNF1 {
        ...
        enum bits : uint8_t {
            PCLKSEL1 = 2,   // PSC 1 Input Clock Select
            POP1     = 4,   // PSC 1 Output Polarity
            PMODE10  = 8,   // PSC 1 Mode
            PMODE11  = 16,  // PSC 1 Mode
            PLOCK1   = 32,  // PSC 1 Lock
            PALOCK1  = 64,  // PSC 1 Autolock
            PFIFTY1  = 128, // PSC 1 Fifty
        };
    };
    ...
    struct PCTL1 {
        ...
        enum bits : uint8_t {
            PRUN1  = 1,   // PSC 1 Run
            PCCYC1 = 2,   // PSC1 Complete Cycle
            PARUN1 = 4,   // PSC1 Auto Run
            PAOC1A = 8,   // PSC 1 Asynchronous Output Control A
            PAOC1B = 16,  // PSC 1 Asynchronous Output Control B
            PBFM1  = 32,  // Balance Flank Width Modulation
            PPRE10 = 64,  // PSC 1 Prescaler Selects
            PPRE11 = 128, // PSC 1 Prescaler Selects
        };
    };
    ...
    struct PFRC1A {
        ...
        enum bits : uint8_t {
            PRFM1A0 = 1,   // PSC 1 Retrigger and Fault Mode for Part A
            PRFM1A1 = 2,   // PSC 1 Retrigger and Fault Mode for Part A
            PRFM1A2 = 4,   // PSC 1 Retrigger and Fault Mode for Part A
            PRFM1A3 = 8,   // PSC 1 Retrigger and Fault Mode for Part A
            PFLTE1A = 16,  // PSC 1 Filter Enable on Input Part A
            PELEV1A = 32,  // PSC 1 Edge Level Selector on Input Part A
            PISEL1A = 64,  // PSC 1 Input Select for Part A
            PCAE1A  = 128, // PSC 1 Capture Enable Input Part A
        };
    };
    ...
    struct PFRC1B {
        ...
        enum bits : uint8_t {
            PRFM1B0 = 1,   // PSC 1 Retrigger and Fault Mode for Part B
            PRFM1B1 = 2,   // PSC 1 Retrigger and Fault Mode for Part B
            PRFM1B2 = 4,   // PSC 1 Retrigger and Fault Mode for Part B
            PRFM1B3 = 8,   // PSC 1 Retrigger and Fault Mode for Part B
            PFLTE1B = 16,  // PSC 1 Filter Enable on Input Part B
            PELEV1B = 32,  // PSC 1 Edge Level Selector on Input Part B
            PISEL1B = 64,  // PSC 1 Input Select for Part B
            PCAE1B  = 128, // PSC 1 Capture Enable Input Part B
        };
    };

    // PSC 1 Input Capture Register
    struct PICR1 {
        static const uint16_t address = 0xee;
        enum bits : uint8_t {
            PICR10 = 1,     // PSC 1 Input Capture Bytes
            PICR11 = 2,     // PSC 1 Input Capture Bytes
            PICR12 = 4,     // PSC 1 Input Capture Bytes
            PICR13 = 8,     // PSC 1 Input Capture Bytes
            PICR14 = 16,    // PSC 1 Input Capture Bytes
            PICR15 = 32,    // PSC 1 Input Capture Bytes
            PICR16 = 64,    // PSC 1 Input Capture Bytes
            PICR17 = 128,   // PSC 1 Input Capture Bytes
            PCST1  = 32768, // PSC 1 Input Capture Software Trig
        };
    };
    ...
    struct PSOC2 {
        ...
        enum bits : uint8_t {
            ...
            PSYNC2_0 = 16,  // Synchronization Out for ADC Selection
            PSYNC2_1 = 32,  // Synchronization Out for ADC Selection
    ...
    struct OCR2SA {
        ...
        enum bits : uint8_t {
            OCR2SA0 = 1,   // Output Compare SA
            OCR2SA1 = 2,   // Output Compare SA
            OCR2SA2 = 4,   // Output Compare SA
            OCR2SA3 = 8,   // Output Compare SA
            OCR2SA4 = 16,  // Output Compare SA
            OCR2SA5 = 32,  // Output Compare SA
            OCR2SA6 = 64,  // Output Compare SA
            OCR2SA7 = 128, // Output Compare SA
        };
    };
    ...
    struct OCR2RA {
        ...
        enum bits : uint8_t {
            OCR2RA0 = 1,   // Output Compare RA
            OCR2RA1 = 2,   // Output Compare RA
            OCR2RA2 = 4,   // Output Compare RA
            OCR2RA3 = 8,   // Output Compare RA
            OCR2RA4 = 16,  // Output Compare RA
            OCR2RA5 = 32,  // Output Compare RA
            OCR2RA6 = 64,  // Output Compare RA
            OCR2RA7 = 128, // Output Compare RA
        };
    };
    ...
    struct OCR2SB {
        ...
        enum bits : uint8_t {
            OCR2SB0 = 1,   // Output Compare SB
            OCR2SB1 = 2,   // Output Compare SB
            OCR2SB2 = 4,   // Output Compare SB
            OCR2SB3 = 8,   // Output Compare SB
            OCR2SB4 = 16,  // Output Compare SB
            OCR2SB5 = 32,  // Output Compare SB
            OCR2SB6 = 64,  // Output Compare SB
            OCR2SB7 = 128, // Output Compare SB
        };
    };
    ...
    struct OCR2RB {
        ...
        enum bits : uint8_t {
            OCR2RB0 = 1,   // Output Compare RB
            OCR2RB1 = 2,   // Output Compare RB
            OCR2RB2 = 4,   // Output Compare RB
            OCR2RB3 = 8,   // Output Compare RB
            OCR2RB4 = 16,  // Output Compare RB
            OCR2RB5 = 32,  // Output Compare RB
            OCR2RB6 = 64,  // Output Compare RB
            OCR2RB7 = 128, // Output Compare RB
        };
    };
