#ifndef atmega169pa_sfr_h
#define atmega169pa_sfr_h
...
namespace SFR {
    ...
    struct GPIOR0 {
        ...
        enum bits : uint8_t {
            GPIOR00 = 1,   // General Purpose Bits
            GPIOR01 = 2,   // General Purpose Bits
            GPIOR02 = 4,   // General Purpose Bits
            GPIOR03 = 8,   // General Purpose Bits
            GPIOR04 = 16,  // General Purpose Bits
            GPIOR05 = 32,  // General Purpose Bits
            GPIOR06 = 64,  // General Purpose Bits
            GPIOR07 = 128, // General Purpose Bits
        };
    };
    ...
    struct GPIOR1 {
        ...
        enum bits : uint8_t {
            GPIOR10 = 1,   // General Purpose Bits
            GPIOR11 = 2,   // General Purpose Bits
            GPIOR12 = 4,   // General Purpose Bits
            GPIOR13 = 8,   // General Purpose Bits
            GPIOR14 = 16,  // General Purpose Bits
            GPIOR15 = 32,  // General Purpose Bits
            GPIOR16 = 64,  // General Purpose Bits
            GPIOR17 = 128, // General Purpose Bits
        };
    };
    ...
    struct GPIOR2 {
        ...
        enum bits : uint8_t {
            GPIOR20 = 1,   // General Purpose Bits
            GPIOR21 = 2,   // General Purpose Bits
            GPIOR22 = 4,   // General Purpose Bits
            GPIOR23 = 8,   // General Purpose Bits
            GPIOR24 = 16,  // General Purpose Bits
            GPIOR25 = 32,  // General Purpose Bits
            GPIOR26 = 64,  // General Purpose Bits
            GPIOR27 = 128, // General Purpose Bits
        };
    };
    ...
    struct OCR2A {
        ...
        enum bits : uint8_t {
            OCR2A0 = 1,   // Timer/Counter2 Output Compare A
            OCR2A1 = 2,   // Timer/Counter2 Output Compare A
            OCR2A2 = 4,   // Timer/Counter2 Output Compare A
            OCR2A3 = 8,   // Timer/Counter2 Output Compare A
            OCR2A4 = 16,  // Timer/Counter2 Output Compare A
            OCR2A5 = 32,  // Timer/Counter2 Output Compare A
            OCR2A6 = 64,  // Timer/Counter2 Output Compare A
            OCR2A7 = 128, // Timer/Counter2 Output Compare A
        };
    };
    ...
    struct USIDR {
        ...
        enum bits : uint8_t {
            USIDR0 = 1,   // USI Data bits
            USIDR1 = 2,   // USI Data bits
            USIDR2 = 4,   // USI Data bits
            USIDR3 = 8,   // USI Data bits
            USIDR4 = 16,  // USI Data bits
            USIDR5 = 32,  // USI Data bits
            USIDR6 = 64,  // USI Data bits
            USIDR7 = 128, // USI Data bits
        };
    };
    ...
    struct LCDCCR {
        ...
        enum bits : uint8_t {
            ...
            LCDDC0 = 32,  // LCD Display Configuration Bits
            LCDDC1 = 64,  // LCD Display Configuration Bits
            LCDDC2 = 128, // LCD Display Configuration Bits
        };
    };
