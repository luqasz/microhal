#ifndef at90pwm1_sfr_h
#define at90pwm1_sfr_h
...
namespace SFR {
    ...
    struct ADCSRB {
        ...
        enum bits : uint8_t {
            ...
            ADASCR = 16,  // ADC Start Conversion
    ...
    struct PICR0 {
        ...
        enum bits : uint8_t {
            PICR00 = 1,     // PSC 0 Capture Register
            PICR01 = 2,     // PSC 0 Capture Register
            PICR02 = 4,     // PSC 0 Capture Register
            PICR03 = 8,     // PSC 0 Capture Register
            PICR04 = 16,    // PSC 0 Capture Register
            PICR05 = 32,    // PSC 0 Capture Register
            PICR06 = 64,    // PSC 0 Capture Register
            PICR07 = 128,   // PSC 0 Capture Register
            PCST0  = 32768, // PSC 0 Capture Software Trig bit
        };
    };
    ...
    struct PSOC1 {
        ...
        enum bits : uint8_t {
            ...
            PSYNC10 = 16, // Synchronization Out for ADC Selection
            PSYNC11 = 32, // Synchronization Out for ADC Selection
        };
    };
    ...
    struct PICR2 {
        ...
        enum bits : uint8_t {
            PICR20 = 1,     // PSC 2 Input Capture Register
            PICR21 = 2,     // PSC 2 Input Capture Register
            PICR22 = 4,     // PSC 2 Input Capture Register
            PICR23 = 8,     // PSC 2 Input Capture Register
            PICR24 = 16,    // PSC 2 Input Capture Register
            PICR25 = 32,    // PSC 2 Input Capture Register
            PICR26 = 64,    // PSC 2 Input Capture Register
            PICR27 = 128,   // PSC 2 Input Capture Register
            PCST2  = 32768, // PSC 2 Capture Software Trig bit
        };
    };
