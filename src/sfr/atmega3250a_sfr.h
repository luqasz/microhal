#ifndef atmega3250a_sfr_h
#define atmega3250a_sfr_h
...
namespace SFR {
    ...
    struct PCMSK0 {
        ...
        enum bits : uint8_t {
            PCINT0 = 1,   // Pin Change Mask bits
            PCINT1 = 2,   // Pin Change Mask bits
            PCINT2 = 4,   // Pin Change Mask bits
            PCINT3 = 8,   // Pin Change Mask bits
            PCINT4 = 16,  // Pin Change Mask bits
            PCINT5 = 32,  // Pin Change Mask bits
            PCINT6 = 64,  // Pin Change Mask bits
            PCINT7 = 128, // Pin Change Mask bits
        };
    };
