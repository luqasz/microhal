#ifndef atmega324pa_sfr_h
#define atmega324pa_sfr_h
...
namespace SFR {
    ...
    struct SPDR0 {
        ...
        enum bits : uint8_t {
            SPDR00 = 1,   // SPI Data bits
            SPDR01 = 2,   // SPI Data bits
            SPDR02 = 4,   // SPI Data bits
            SPDR03 = 8,   // SPI Data bits
            SPDR04 = 16,  // SPI Data bits
            SPDR05 = 32,  // SPI Data bits
            SPDR06 = 64,  // SPI Data bits
            SPDR07 = 128, // SPI Data bits
        };
    };
    ...
    struct OCR2A {
        ...
        enum bits : uint8_t {
            OCR2A0 = 1,   // Timer/Counter0 Output Compare A bits
            OCR2A1 = 2,   // Timer/Counter0 Output Compare A bits
            OCR2A2 = 4,   // Timer/Counter0 Output Compare A bits
            OCR2A3 = 8,   // Timer/Counter0 Output Compare A bits
            OCR2A4 = 16,  // Timer/Counter0 Output Compare A bits
            OCR2A5 = 32,  // Timer/Counter0 Output Compare A bits
            OCR2A6 = 64,  // Timer/Counter0 Output Compare A bits
            OCR2A7 = 128, // Timer/Counter0 Output Compare A bits
        };
    };
    ...
    struct UBRR1 {
        ...
        enum bits : uint8_t {
            UBRR10 = 1,   // USART Baud Rate bits
            UBRR11 = 2,   // USART Baud Rate bits
            UBRR12 = 4,   // USART Baud Rate bits
            UBRR13 = 8,   // USART Baud Rate bits
            UBRR14 = 16,  // USART Baud Rate bits
            UBRR15 = 32,  // USART Baud Rate bits
            UBRR16 = 64,  // USART Baud Rate bits
            UBRR17 = 128, // USART Baud Rate bits
        };
    };
