#ifndef atmega128rfa1_sfr_h
#define atmega128rfa1_sfr_h
...
namespace SFR {
    ...
    struct PHY_TX_PWR {
        ...
        enum bits : uint8_t {
            ...
            PA_LT0     = 16,  // Power Amplifier Lead Time
            PA_LT1     = 32,  // Power Amplifier Lead Time
            PA_BUF_LT0 = 64,  // Power Amplifier Buffer Lead Time
            PA_BUF_LT1 = 128, // Power Amplifier Buffer Lead Time
        };
    };
