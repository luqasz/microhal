...
namespace PinIRQ {
    ...
    struct INT2 {
        ...
        static constexpr uint8_t MASK           = inverted<uint8_t>(EDGE_REG.ISC21 | EDGE_REG.ISC20);
    };
    ...
    struct INT3 {
        ...
        static constexpr uint8_t MASK           = inverted<uint8_t>(EDGE_REG.ISC31 | EDGE_REG.ISC30);
    };
    ...
    struct INT4 {
        ...
        static constexpr uint8_t MASK           = inverted<uint8_t>(EDGE_REG.ISC41 | EDGE_REG.ISC40);
    };
    ...
    struct INT5 {
        ...
        static constexpr uint8_t MASK           = inverted<uint8_t>(EDGE_REG.ISC51 | EDGE_REG.ISC50);
    };
    ...
    struct INT6 {
        ...
        static constexpr uint8_t MASK           = inverted<uint8_t>(EDGE_REG.ISC61 | EDGE_REG.ISC60);
    };
    ...
    struct INT7 {
        ...
        static constexpr uint8_t MASK           = inverted<uint8_t>(EDGE_REG.ISC71 | EDGE_REG.ISC70);
    };
}
